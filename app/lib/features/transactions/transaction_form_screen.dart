...
class _TransactionFormScreenState
  ...
  Future<void> _save() async {
    ...
    try {
      ...
      final tx = TransactionModel(
        ...
        categorieFiscale:
            _selectedType == CategoryType.depense ? _categorieFiscale : null,
        recurrentSourceId: null,
      );
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text('NOUVELLE TRANSACTION', style: AppTextStyles.sectionTitle),
      ),
            ...
            child: Column(
              ...
              children: [
                    ...
                    return GestureDetector(
                      onTap: () {
                        ...
                        setState(() {
                          ...
                          if (newId != null && !_fiscalManuallyTouched) {
                      ...
                      for (int i = 0; i < members.length; i++) ...[
                        ...
                        Expanded(
                          child: _pill(
                            ...
                            onTap: () =>
                                setState(() => _auteurId = members[i].id),
                          ),
                        ),
                      ],
                    ],
                ...
                if (_selectedType == CategoryType.depense) ...[
                  ...
                  InkWell(
                    onTap: () =>
                        setState(() => _fiscalExpanded = !_fiscalExpanded),
                    child: Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
                        Text(
                          _categorieFiscale == 'non_deductible'
                              ? 'Catégorie fiscale'
                              : (fiscalPosteLabel(_categorieFiscale) ??
                                  'Catégorie fiscale'),
                          style: AppTextStyles.body.copyWith(
                            fontSize: 13,
                            color: _categorieFiscale == 'non_deductible'
                                ? AppColors.muted
                                : AppColors.ink,
                          ),
                        ),
